...
<body>
    ...
    <main class="container">
        <div class="row dateselection">
            <div class="col-1"><button id="datebtn1" class="datebtn" onClick="selectDate(this.id)" type="button"><span tabindex="-1"><h3>2002</h3></span></button></div>
            <div class="col-1"><button id="datebtn2" class="datebtn" onClick="selectDate(this.id)" type="button"><span tabindex="-1"><h3>2003</h3></span></button></div>
            <div class="col-1"><button id="datebtn3" class="datebtn" onClick="selectDate(this.id)" type="button"><span tabindex="-1"><h3>2004</h3></span></button></div>
            <div class="col-1"><button id="datebtn4" class="datebtn" onClick="selectDate(this.id)" type="button"><span tabindex="-1"><h3>2005</h3></span></button></div>
            <div class="col-1"><button id="datebtn5" class="datebtn" onClick="selectDate(this.id)" type="button"><span tabindex="-1"><h3>2006</h3></span></button></div>
            <div class="col-1"><button id="datebtn6" class="datebtn" onClick="selectDate(this.id)" type="button"><span tabindex="-1"><h3>2007</h3></span></button></div>
        </div>
        <div class="row">
            <div class="col-6">
                <ul class="timeline">
                    <li class="before navbutton"><button type="button" onclick="beforeBox()"><span tabindex="-1">&lsaquo;</span></button></li
                    ><li class="timelineelement"><h3>GCTF Tourney Winter</h3><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque fermentum, tellus eget pellentesque ullamcorper, metus dolor semper massa, eget interdum augue diam eu dui. Quisque sapien sem, posuere vel rutrum eget, auctor ac nulla. Vestibulum laoreet gravida tortor, sed pulvinar diam ultrices et. Sed id luctus nulla. Suspendisse quis massa ut eros ornare hendrerit nec a lacus. Sed et elit in neque tincidunt volutpat. Sed tristique ultricies arcu, id viverra magna venenatis id. Curabitur quis rutrum massa. Nullam tristique, turpis quis pulvinar aliquam, ex purus eleifend dui, et semper tellus risus sit amet dui. Proin tristique in justo vel gravida.</p></li 
                    ><li class="timelineelement"><h3>1on1</h3><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque fermentum, tellus eget pellentesque ullamcorper, metus dolor semper massa, eget interdum augue diam eu dui. Quisque sapien sem, posuere vel rutrum eget, auctor ac nulla. Vestibulum laoreet gravida tortor, sed pulvinar diam ultrices et. Sed id luctus nulla. Suspendisse quis massa ut eros ornare hendrerit nec a lacus. Sed et elit in neque tincidunt volutpat. Sed tristique ultricies arcu, id viverra magna venenatis id. Curabitur quis rutrum massa. Nullam tristique, turpis quis pulvinar aliquam, ex purus eleifend dui, et semper tellus risus sit amet dui. Proin tristique in justo vel gravida.</p></li
                    ><li class="timelineelement"><h3>GCTF Tourney Summer</h3><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentes